export const TableHeaders = [
  ...
  { name: "Identificação Nucleo CEG", key: "ideNucleoCEG", type: "decimal" },
  ...
  { name: "Média Potência Outorgada (KW)", key: "mdaPotenciaOutorgadaKw", type: "decimal" },
  { name: "Média Tensão Conexão", key: "mdaTensaoConexao", type: "decimal" },
  { name: "Nome da Empresa Conexão", key: "nomEmpresaConexao", type: "text" },
  { name: "CNPJ da Empresa Conexão", key: "numCnpjEmpresaConexao", type: "cnpj" },
];
